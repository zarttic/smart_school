    ...
    2017: function (e, t, o) {
        ...
        var s = function () {
            ...
            return o("div", {staticClass: "login-container"}, [o("el-form", {
                ...
                on: {click: e.showPwd}
            }, [o("svg-icon", {attrs: {"icon-class": "password" === e.passwordType ? "eye" : "eye-open"}})], 1)], 1), o("el-form-item", {attrs: {prop: "verifyCode"}}, [o("span", {staticClass: "svg-container"}, [o("svg-icon", {attrs: {"icon-class": "people"}})], 1), o("el-input", {
                ref: "verifyCode",
                attrs: {placeholder: "验证码", name: "verifyCode"},
                model: {
                    value: e.loginForm.verifyCode, callback: function (t) {
                        e.$set(e.loginForm, "verifyCode", t)
            ...
            name: "Login", data: function () {
                ...
                return {
                    codeImgUrl: "".concat(this.$BASE_API, "/sms/system/getVerifyCodeImage"),
                    loginForm: {username: "admin", password: "admin", verifyCode: null, userType: null},
                    loginRules: {
                        username: [{required: !0, validator: e}],
                        password: [{required: !0, trigger: "blur", validator: t}],
                        verifyCode: [{required: !0, message: "必须输入验证码"}],
                ...
                updateCode: function () {
                    this.codeImgUrl = "".concat(this.$BASE_API, "/sms/system/getVerifyCodeImage?t=").concat(Date.now())
                }, showPwd: function () {
                    var e = this;
